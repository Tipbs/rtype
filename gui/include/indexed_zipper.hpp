...
template<class ...Containers>
inline indexed_zipper<Containers...>::iterator indexed_zipper<Containers...>::begin()
{
	return iterator(_begin, _size);
}

template<class ...Containers>
inline indexed_zipper<Containers...>::iterator indexed_zipper<Containers...>::end()
{
    return iterator(_end, _size, _size);
}

template<class ...Containers>
inline size_t indexed_zipper<Containers...>::_compute_size(Containers & ...containers)
{
    return std::max({containers.size()...});
}

template<class ...Containers>
inline indexed_zipper<Containers...>::iterator_tuple indexed_zipper<Containers...>::_compute_end(Containers & ...containers)
{
