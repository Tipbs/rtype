...
void Factory::register_components()
{
    _reg.register_components<
        ...
        // HUD,
        Rect, Color, Text, ScoreText, ChargeRect,
#endif
...
void Factory::add_systems()
{
    ...
    _reg.add_system<Position, Size, SpawnGrace, Damages, Health, Point, Score>(colision);
...
#ifndef SERVER
    _reg.add_system<
        Position, Sprite, Player, Rectangle, InputField, Rect, Color,
        Text>(display);
...
const Entity Factory::create_boss(Position pos)
{
    ...
    _reg.emplace_component<NetworkedEntity>(
        new_entity, (size_t) new_entity + 3, EntityType::Boss);
