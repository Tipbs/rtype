...
class indexed_zipper_iterator {
  ...
  public:
    ...
    friend bool operator==(
        indexed_zipper_iterator const &lhs, indexed_zipper_iterator const &rhs)
    {
...
template<class... Containers>
inline indexed_zipper_iterator<Containers...>
...
template<class... Containers>
inline indexed_zipper_iterator<Containers...>::value_type
indexed_zipper_iterator<Containers...>::operator*()
{
...
template<size_t... Is>
inline void
indexed_zipper_iterator<Containers...>::incr_all(std::index_sequence<Is...>)
{
    if (_idx >= _max)
        return;
    _idx++;
...
template<size_t... Is>
inline bool
indexed_zipper_iterator<Containers...>::all_set(std::index_sequence<Is...> seq)
{
